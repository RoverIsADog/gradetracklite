...
The back-end of GradeTrackLite is implemented using JavaScript, Node.js, and Express.js. Node.js provides a runtime environment for executing JavaScript code on the server-side, while Express.js is a lightweight web application framework that simplifies the process of building RESTful APIs.

We designed our back-end to handle user authentication, data processing, and communication with the database. The choice of JavaScript as the primary programming language for the back-end allowed seamless integration with the React front-end and facilitated a smooth development experience.
